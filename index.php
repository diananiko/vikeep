...
<div class="navbar navbar-inverse">
	<div class="navbar-inner">
		...
		<ul class="nav">
			...
			<li class="active"><a href="https://github.com/diananiko/vikeep">GitHub</a></li>
		</ul>
...
<?php
	...
	if( $count ) {
		...
		$strRoUrl = $viki->subtitles($_GET['episode'],"ro");
		...
		echo " <a href='".$strRoUrl."' title='Download Romanian subtitles' class='btn btn-large btn-primary'><i class='icon-list-alt icon-white'></i> Romanin</a>";
